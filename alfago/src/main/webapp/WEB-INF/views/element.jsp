...
<html>
  ...
  <script id="table-template" type="text/x-handlebars-template">
                                         {{#each this}}
                                            <tr>
                                                <td class="id">{{id}}</td>
                                                <td class="editable keyname">{{keyname}}</td>
                                                <td class="editable value">{{value}}</td>
...
<script id="template" type="text/x-handlebars-template"> 
                                            <tr>
                                                <td class="id"></td>
                                                <td class="editable keyname"><input type="text" id="inputWarning" class="form-control"></td>
                                                <td class="editable value"><input type="text" id="inputWarning" class="form-control"></td>
